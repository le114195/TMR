    ...
    override func drawRect(rect: CGRect) {
        ...
        for i in 0...self.arrayData.count-1 {
            ...
            for j in 0...arrM.count - 1 {
                ...
                let percent:Double = dict.valueForKey("percent") as! Double
                CGContextAddLineToPoint(context, x, 75 + CGFloat((1 - percent) * 100))
            }
        }
